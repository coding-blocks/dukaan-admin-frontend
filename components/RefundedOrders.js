...
class RefundedOrders extends React.Component {
    ...
    handleRefundDetails = () => {
        refundController.handleGetRefundFromTxnId(this.props.txn_id).then(refundData => {
            this.setState({
                firstname: refundData.data.refund_created_by.firstname,
                lastname: refundData.data.refund_created_by.lastname,
                refundDetail: refundData.data,
